...
public class OmsService {
    ...
    public List<HotelRoomRateResponse> getHotelRoomRate(HotelRoomRateRequest request) {
        ApiResponse<List<HotelRoomRateResponse>> response = webClientBuilder.build()
            ...
            .header("Authorization", "Bearer eyJhbGciOiJIUzI1NiJ9.eyJjb21wYW55SWQiOjEsInVzZXJJZCI6NCwic3ViIjoiY29tYXBueWFkbWluLmFiaUBleGFtcGxlLmNvbSIsImlhdCI6MTc3MDMwNDc0NywiZXhwIjoxNzcwMzkxMTQ3fQ.WUKJm1TzpoSCgIIakVvhnkoQbYnKj8pnt9zBsxGJUwU")
            .bodyValue(request)
            .retrieve()
