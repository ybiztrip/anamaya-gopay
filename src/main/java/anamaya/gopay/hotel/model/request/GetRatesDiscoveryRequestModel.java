...
public class GetRatesDiscoveryRequestModel {
    ...
    private GetRatesDiscoveryFilterRequestModel filters;
    private String cursor;

    public GetRatesDiscoveryRequestModel() {
        this.geoId = "";
        this.checkInDate = "";
        this.checkOutDate = "";
        this.numRooms = 1;
    ...
    public GetRatesDiscoveryFilterRequestModel getFilters() {
        return filters;
    }

    public void setFilters(GetRatesDiscoveryFilterRequestModel filters) {
